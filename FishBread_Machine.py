...
#   2-2. 입력은 단팥, 슈크림, 고구마무스 중 고른 것 개수
# 3. 출력 : 단팥: 개수, 슈크림: 개수, 고구마무스: 개수, 총 #개로 #원 입니다.
...
for fish in fish_choice:
    ...
    fish_ea.append((fish, fish_num)) #붕어빵, 개수를 ()로 담아 리스트로 모두 넣음.
...
for fish, fish_num in fish_ea:
    ...
    all_num += fish_num #붕어빵 개수 모두 구하기
...
# !부족한 것 붕어빵별 개수 구해서 출력하기, 붕어빵 종류 외 입력시 다시 입력하라고 하기, 붕어빵 개수 입력시 숫자가 아니면 다시 입력하라고 하기